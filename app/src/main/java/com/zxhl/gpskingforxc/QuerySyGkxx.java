    ...
    * */
    public HashMap<String,String> parseSoap(SoapObject result){
        ...
        for (int i=0;i<soapObject.getPropertyCount();i++){
            ...
            if (str.length>=2) {
                if(str[0].equals("开/关机")||str[0].equals("最新有效位置时间")){
                    str=soapObject.getProperty(i).toString().split(",");
                }
                map.put(str[0],str[1]);
            }
    ...
    private void showWorkData(){
        ...
        //显示数据
        //工作状态
        txt_dwsj.setText(map.get("开/关机:"));
        txt_wz.setText(map.get("注册状态"));
        txt_jd.setText(map.get("监控状态"));
        txt_wd.setText(map.get("锁机模式"));
        // 故障信息
        txt_zsj.setText(map.get("故障代码"));
        //txt_jtsj.setText(map.get("今天工作小时"));
        // 工作位置
        txt_yyyw.setText(map.get("最新有效位置时间:"));
        txt_swgr.setText(map.get("最新有效位置"));
        ...
        // 工作时间
        txt_sjc.setText(map.get("总工作时间"));
        txt_jk.setText(map.get("总作业时间"));
        // 车台信息
        txt_gpstx.setText(map.get("机号"));
        txt_sjxh.setText(map.get("SIM卡号"));
        txt_dlzx.setText(map.get("车台编号"));
        txt_gpszs_acc.setText(map.get("车台类型"));
        txt_yjsc_sdms.setText(map.get("车辆类型"));
        txt_gpssj.setText(map.get("所属地区"));
        txt_gpsbj.setText(map.get("所属分组"));
        txt_zdyqk.setText(map.get("车台程序版本号"));
        ...
        // 工况信息
        txt_zhgk.setText(map.get("系统电压"));
        txt_dy.setText(map.get("发动机转速"));
        txt_sw.setText(map.get("发动机运转时间"));
        txt_yw.setText(map.get("发动机冷却液温度"));
